...
export default function GeneralTestViewGrid(props) {
    ...
    const columns = [
        ...
        { field: 'component_view',
            headerName: 'Past Results',
            width: 180,
            renderCell: (params) => (
                <strong>
                    <Button
                        ...
                        color="primary"
                        size="small"
                        onClick={() => history.push(`/patient/test/component/${typeId}/${params.getValue('parameter_name')}`)}
                    >
                        Open
                    </Button>
                </strong>
